...
My current research primarily centers around **medical image analysis**, **computer vision**, and **deep learning** -- with a special focus on solving challenges in decentralized training of machine learning models on: (a) class-imbalanced data distributions, and (b) in absence of labels. My research interests include **federated learning**, **self-supervised learning**, **semi-supervised learning**, **Speech Motor Control**, and **Brain-Computer Interfaces**.
